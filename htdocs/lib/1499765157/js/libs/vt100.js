  ...
  if (typeof userCSSList != 'undefined') {
    ...
    for (var i = 0; i <= userCSSList.length; ++i) {
      if (i < userCSSList.length) {
        ...
        var path                         = userCSSList[i][3] || '';	// Custom EdgeOS addition
        ...
        href.nodeValue                   = path + 'usercss-' + i + '.css';
                  ...
                  if (entry.tagName == 'LI') {
                    if (++i >= begin) {
                      ...
                      if (i == current) {
                        ...
                        if (!sheet.disabled) {
                          label.innerHTML= '<img src="/media/cli/enabled.gif" />' +
                                           label.innerHTML;
                        }
                      } else {
                        sheet.disabled   = true;
      ...
      group                             +=
        '<li>' + (enabled ? '<img src="/media/cli/enabled.gif" />' : '') +
                 label +
        '</li>';
    }
    ...
    '<table class="popup" ' +
      ...
      '<tr><td>' +
        '<ul id="menuentries">' +
          ...
          '<hr />' +
          '<li id="beginconfig">' +
             (this.utfEnabled ? '<img src="/media/cli/enabled.gif" />' : '') +
             'Unicode</li>' +
          '<li id="endconfig">' +
             (this.visualBell ? '<img src="/media/cli/enabled.gif" />' : '') +
             'Visual Bell</li>'+
...
VT100.prototype.keyDown = function(event) {
  ...
  var normalKey                 =
    ...
    event.keyCode == 173 || // Custom EdgeOS addition for - and _ in Firefox
    event.keyCode == 252;
  try {
